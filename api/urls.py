...
from .views_user import UserApiView, UserCurrent, AddArtist, RemoveArtist, AddFriend, RemoveFriend, UserFriends, UserArtists

urlpatterns = [
    path('user/', UserApiView.as_view()),
    path('user/me/', UserCurrent.as_view()),
    path('user/artists/', UserArtists.as_view()),
